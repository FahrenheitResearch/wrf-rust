...
pub static VARS: &[VarDef] = &[
    ...
    VarDef {
        name: "sb3cape",
        aliases: &["surface_based_3cape", "surface_based_0_3km_cape"],
        description: "Surface-based CAPE in the lowest 3 km",
        default_units: "J/kg",
        dim: VarDim::TwoD,
        compute: dcape::compute_sb3cape,
    },
    VarDef {
        name: "ml3cape",
        aliases: &["3cape", "mixed_layer_3cape", "mixed_layer_0_3km_cape"],
        description: "Mixed-layer CAPE in the lowest 3 km",
        default_units: "J/kg",
        dim: VarDim::TwoD,
        compute: dcape::compute_ml3cape,
    },
    VarDef {
        name: "mu3cape",
        aliases: &["most_unstable_3cape", "most_unstable_0_3km_cape"],
        description: "Most-unstable CAPE in the lowest 3 km",
        default_units: "J/kg",
        dim: VarDim::TwoD,
        compute: dcape::compute_mu3cape,
    },
    VarDef {
        name: "sb6cape",
        aliases: &["surface_based_6cape", "surface_based_0_6km_cape"],
        description: "Surface-based CAPE in the lowest 6 km",
        default_units: "J/kg",
        dim: VarDim::TwoD,
        compute: dcape::compute_sb6cape,
    },
    VarDef {
        name: "ml6cape",
        aliases: &["6cape", "mixed_layer_6cape", "mixed_layer_0_6km_cape"],
        description: "Mixed-layer CAPE in the lowest 6 km",
        default_units: "J/kg",
        dim: VarDim::TwoD,
        compute: dcape::compute_ml6cape,
    },
    VarDef {
        name: "mu6cape",
        aliases: &["most_unstable_6cape", "most_unstable_0_6km_cape"],
        description: "Most-unstable CAPE in the lowest 6 km",
        default_units: "J/kg",
        dim: VarDim::TwoD,
        compute: dcape::compute_mu6cape,
    },
    VarDef {
        name: "lcl",
        aliases: &["lcl_height"],
    ...
    VarDef {
        name: "dcape",
        aliases: &["downdraft_cape"],
        description: "Downdraft CAPE",
        default_units: "J/kg",
        dim: VarDim::TwoD,
        compute: dextra::compute_dcape,
    },
    VarDef {
        name: "dcp",
        aliases: &["derecho_composite_parameter"],
        description: "Derecho Composite Parameter",
        default_units: "dimensionless",
        dim: VarDim::TwoD,
        compute: dsevere::compute_dcp,
    },
    VarDef {
        name: "wndg",
        aliases: &["wind_damage_parameter"],
        description: "Wind Damage Parameter",
        default_units: "dimensionless",
        dim: VarDim::TwoD,
        compute: dsevere::compute_wndg,
    },
    VarDef {
        name: "esp",
        aliases: &["enhanced_stretching_potential"],
        description: "Enhanced Stretching Potential",
        default_units: "dimensionless",
        dim: VarDim::TwoD,
        compute: dsevere::compute_esp,
    },
    VarDef {
        name: "mmp",
        aliases: &["mcs_maintenance_probability"],
        description: "MCS Maintenance Probability",
        default_units: "dimensionless",
        dim: VarDim::TwoD,
        compute: dsevere::compute_mmp,
    },
    VarDef {
    ...
    VarDef {
        ...
        default_units: "dimensionless",
        dim: VarDim::TwoD,
        compute: dextra::compute_k_index,
    },
    VarDef {
        name: "total_totals",
        aliases: &["totals_totals", "t_totals", "tot_tots"],
        description: "Total Totals Index",
        default_units: "dimensionless",
        dim: VarDim::TwoD,
        compute: dextra::compute_total_totals,
    },
    VarDef {
        name: "mean_mixr",
        aliases: &["mean_mixing_ratio", "low_level_mean_mixr"],
        description: "Mean mixing ratio in the lowest 100 hPa",
        default_units: "g/kg",
        dim: VarDim::TwoD,
        compute: dextra::compute_mean_mixr,
    },
    VarDef {
        name: "low_rh",
        aliases: &["low_level_rh", "mean_low_rh"],
        description: "Mean RH in the lowest 100 hPa",
        default_units: "%",
        dim: VarDim::TwoD,
        compute: dextra::compute_low_rh,
    },
    VarDef {
        name: "mid_rh",
        aliases: &["mid_level_rh", "mean_mid_rh"],
        description: "Mean RH from 700-500 hPa",
        default_units: "%",
        dim: VarDim::TwoD,
        compute: dextra::compute_mid_rh,
    },
    VarDef {
        name: "dgz_rh",
        aliases: &["dendritic_growth_zone_rh"],
        description: "Mean RH through the dendritic growth zone",
        default_units: "%",
        dim: VarDim::TwoD,
        compute: dextra::compute_dgz_rh,
    },
    VarDef {
        name: "lcl_temp",
        aliases: &["lcl_temperature"],
        description: "LCL temperature",
        default_units: "degC",
        dim: VarDim::TwoD,
        compute: dextra::compute_lcl_temp,
    },
    VarDef {
        name: "convective_temp",
        aliases: &["conv_t", "convt"],
        description: "Convective temperature",
        default_units: "degC",
        dim: VarDim::TwoD,
        compute: dextra::compute_convective_temp,
    },
    VarDef {
        name: "max_temp",
        aliases: &["forecast_max_temp", "maxt"],
        description: "Forecast maximum surface temperature",
        default_units: "degC",
        dim: VarDim::TwoD,
        compute: dextra::compute_max_temp,
    },
    VarDef {
        name: "theta_w",
...
mod tests {
    ...
    fn common_wrf_python_aliases_resolve() {
        ...
        assert_eq!(get_var_def("6cape").unwrap().name, "ml6cape");
