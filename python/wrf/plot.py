...
_VAR_STYLES: Dict[str, Dict[str, Any]] = {
    ...
    "ecape_scp":     dict(cmap="Reds", levels=np.arange(0, 11, 1), extend="max"),
    "ehi":           dict(cmap="Reds", levels=np.arange(0, 5.5, 0.5), extend="max"),
    "ecape_ehi":     dict(cmap="Reds", levels=np.arange(0, 5.5, 0.5), extend="max"),
    "tehi":          dict(cmap="Reds", levels=np.arange(0, 10.5, 0.5), extend="max"),
    "tts":           dict(cmap="Reds", levels=np.arange(0, 10.5, 0.5), extend="max"),
    "vtp_mod":       dict(cmap="Reds", levels=np.arange(0, 10.5, 0.5), extend="max"),
